                    ...
                    <a-form :model="formState" layout="vertical">
                        <a-form-item v-bind="validateInfos.atrribute_group_name">
                            <template class="h-full" #label>
                                <span class="font-medium">Tên nhóm thuộc tính</span>
                            </template>
                            <a-input
...
const routes = ref([
    ...
    },
    {
        ...
        breadcrumbName: "Quản lý nhóm thuộc tính",
    },
    {
        name: "create-attribute-group",
        breadcrumbName: "Tạo nhóm thuộc tính",
    },
]);

const formState = ref({
    storage_code: null,
    atrribute_group_name: null,
    material_code: null,
});
...
const { resetFields, validate, validateInfos } = useForm(
    ...
    reactive({
        atrribute_group_name: [
            {
                required: true,
                message: "Vui lòng nhập tên nhóm thuộc tính",
            },
        ],
    })
);
...
const onSubmit = async () => {
    validate()
        .then(async (res) => {
            const response = await axios.post("/api/attribute-groups", {
...
const handleChangeMaterialPage = () => {
    router.push({ name: "management-attribute-group" });
};
