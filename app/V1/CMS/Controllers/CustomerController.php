...
use App\V1\CMS\Models\CustomerModel;
use App\V1\CMS\Requests\Customers\CreateRequest;
use App\V1\CMS\Requests\Customers\UpdateRequest;
use App\V1\CMS\Resources\CustomerResource;
use Exception;
...
class CustomerController extends Controller
{
    ...
    public function index(Request $request): ResourceCollection
    {
        ...
        if (isset($input['short'])) {
            return $this->responseIndex(CustomerResource::collection($data));
        }
    ...
    public function create(CreateRequest $request): JsonResponse
    {
        ...
        return $this->responseStoreSuccess('', ['item' => new CustomerResource($data)]);
    }
    ...
    public function detail($id): JsonResponse
    {
        ...
        return $this->responseSuccess('', ['item' => new CustomerResource($item)]);
    }
    ...
    public function update(UpdateRequest $request, $id): JsonResponse
    {
        ...
        return $this->responseUpdateSuccess('', ['item' => new CustomerResource($data)]);
    }
